...
const Contact = () => {
    return (
        <section class="text-gray-400 bg-gray-900 body-font relative">
            <h1 class="text-center md:text-9xl sm:text-5xl text-purple-800">Want to Attribute?</h1>
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                
                <div class="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe width="100%" height="100%" title="map" class="absolute inset-0" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/@22.3353011,91.8438068,15z" style={{filter: 'grayscale(1) contrast(1.2) opacity(0.16)'}}></iframe>
                    <div class="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        ...
                        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            <a class="text-purple-400 leading-relaxed">example@email.com</a>
